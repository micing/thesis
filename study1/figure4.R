...
png(filename = "output/figure4.png",width = 550, height = 450)
...
df=function(x) dnnmax(x, mean=0,
                      sd=nnmax_zadj_3x10_8_1$fixed$sd,
                      sdm=nnmax_zadj_3x10_8_1$fitted[[1]][["sdm"]],
                      k=nnmax_zadj_3x10_8_1$fitted[[1]][["k"]])
plotit(x=a$sim_10_8_1_5$max$zadj, df=df, sub="", sig=TRUE, main=expression(paste("Max (", psi, ")")))
...
df=function(x) dnnmax(x, mean=0,
                      ...
                      sdm=nnmax_zadj_3x10_8_1$fitted[[1]][["sdm"]],
                      k=nnmax_zadj_3x10_8_1$fitted[[1]][["k"]])
plotit(x=a$sim_10_8_1_20$max$zadj, df=df, sub="", sig=TRUE, main=expression(paste("Max (", psi, ")")))
...
df=function(x) dnnmax(x, mean=0,
                      ...
                      sdm=nnmax_zadj_3x10_8_1$fitted[[1]][["sdm"]],
                      k=nnmax_zadj_3x10_8_1$fitted[[1]][["k"]])
plotit(x=a$sim_10_8_1_100$max$zadj, df=df, sub="", sig=TRUE, main=expression(paste("Max (", psi, ")")))
